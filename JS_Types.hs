...
gte   = Proxy :: Proxy GEt
lte   = Proxy :: Proxy LEt
instance E (Proxy Plus) where ev _ = pure "+"
instance E (Proxy Minus) where ev _ = pure "-"
instance E (Proxy Mult) where ev _ = pure "*"
instance E (Proxy Div) where ev _ = pure "/"
instance E (Proxy Eq) where ev _ = pure "=="
instance E (Proxy NEq) where ev _ = pure "!="
instance E (Proxy EEq) where ev _ = pure "==="
instance E (Proxy NEEq) where ev _ = pure "!=="
instance E (Proxy And) where ev _ = pure "&&"
instance E (Proxy Or) where ev _ = pure "||"
instance E (Proxy Gt) where ev _ = pure ">"
instance E (Proxy Lt) where ev _ = pure "<"
instance E (Proxy GEt) where ev _ = pure "=>"
instance E (Proxy LEt) where ev _ = pure "=<"

instance E (Proxy UPlus) where ev _ = pure "+"
instance E (Proxy UMinus) where ev _ = pure "-"
instance E (Proxy Not) where ev _ = pure "!"
instance E (Proxy TypeOf) where ev _ = pure "typeof"
